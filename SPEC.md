...
| `POST /feeds/discover` | AI-assisted feed discovery (location, themes, free-text query); executes LLM candidate topic generation, DuckDuckGo search, HTML `<link>` autodiscovery, curated seeds, and live HTTP/feedparser verification; returns verified feed candidates |
